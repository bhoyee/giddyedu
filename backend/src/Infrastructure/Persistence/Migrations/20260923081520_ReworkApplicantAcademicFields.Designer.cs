...
namespace GiddyEdu.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260923081520_ReworkApplicantAcademicFields")]
    partial class ReworkApplicantAcademicFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GiddyEdu.Modules.Hr.Domain.StaffAdditionalPosition", b =>
                {
                    b.Property<Guid>("TenantId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("TenantId", "StaffId", "PositionId");

                    b.HasIndex("TenantId", "PositionId");

                    b.ToTable("StaffAdditionalPositions", "giddyedu");
                });
            ...
            modelBuilder.Entity("GiddyEdu.Modules.Hr.Domain.StaffProfile", b =>
                {
                    ...
                    b.Property<string>("SuspendedRoleIdsJson")
                        .HasMaxLength(4000)
            ...
            modelBuilder.Entity("GiddyEdu.Modules.Schools.Domain.SchoolProfile", b =>
                {
                    ...
                    b.Property<Guid?>("PrincipalSignatureFileId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "LogoFileId");

                    b.HasIndex("TenantId", "PrincipalSignatureFileId");
            ...
            modelBuilder.Entity("GiddyEdu.Modules.StudentLifecycle.Domain.Applicant", b =>
                {
                    ...
                    b.Property<string>("LastClassCompleted")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
                    ...
                    b.Property<Guid?>("ProposedClassLevelId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GiddyEdu.Modules.StudentLifecycle.Domain.ApplicantGuardian", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ApplicantGuardians", "giddyedu");
                });
            ...
            modelBuilder.Entity("GiddyEdu.Modules.Subscriptions.Domain.TenantSubscription", b =>
                {
                    ...
                    b.ToTable("TenantSubscriptions", "giddyedu", t =>
                        {
                            t.HasCheckConstraint("CK_TenantSubscriptions_Status", "\"Status\" BETWEEN 0 AND 4");

                            t.HasCheckConstraint("CK_TenantSubscriptions_StatusAccess", "(\"IsActive\" = TRUE AND \"Status\" IN (0, 1)) OR (\"IsActive\" = FALSE AND \"Status\" IN (2, 3, 4))");
                        });
                });
            ...
            modelBuilder.Entity("GiddyEdu.Modules.Tenancy.Domain.TenantMembership", b =>
                {
                    ...
                    b.Property<string>("RoleAtSchool")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
            ...
            modelBuilder.Entity("GiddyEdu.Modules.Schools.Domain.SchoolProfile", b =>
                {
                    ...
                    b.HasOne("GiddyEdu.Modules.Platform.Domain.StoredFile", null)
                        .WithMany()
                        .HasForeignKey("TenantId", "LogoFileId")
                        .HasPrincipalKey("TenantId", "Id")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("GiddyEdu.Modules.Platform.Domain.StoredFile", null)
                        .WithMany()
                        .HasForeignKey("TenantId", "PrincipalSignatureFileId")
                        .HasPrincipalKey("TenantId", "Id")
                        .OnDelete(DeleteBehavior.Restrict);
                });
