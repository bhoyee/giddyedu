    ...
    : IdentityDbContext<PlatformUser, IdentityRole<Guid>, Guid>(options)
{
    ...
    public DbSet<StaffNextOfKin> StaffNextOfKinContacts => Set<StaffNextOfKin>();
    ...
    private void ApplyTenantFilters(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<StaffNextOfKin>().HasQueryFilter(x => tenantContext.TenantId.HasValue && x.TenantId == tenantContext.TenantId);
        ...
        modelBuilder.Entity<ApplicantGuardian>().HasQueryFilter(x => tenantContext.TenantId.HasValue && x.TenantId == tenantContext.TenantId);
        ...
        modelBuilder.Entity<StudentProgression>().HasQueryFilter(x => tenantContext.TenantId.HasValue && x.TenantId == tenantContext.TenantId);
    ...
    private static void ConfigureHr(ModelBuilder b)
    {
        ...
        b.Entity<StaffSensitiveRecord>(e => { e.ToTable("StaffSensitiveRecords"); e.HasKey(x => new { x.TenantId, x.StaffId }); e.Property(x => x.Address).HasMaxLength(1000); e.Property(x => x.NextOfKinName).HasMaxLength(200); e.Property(x => x.NextOfKinPhone).HasMaxLength(30); e.Property(x => x.Notes).HasMaxLength(2000); e.Property(x => x.Title).HasMaxLength(30); e.Property(x => x.MiddleName).HasMaxLength(100); e.Property(x => x.Gender).HasMaxLength(30); e.Property(x => x.MaritalStatus).HasMaxLength(40); e.Property(x => x.Religion).HasMaxLength(80); e.Property(x => x.Country).HasMaxLength(100); e.Property(x => x.State).HasMaxLength(100); e.Property(x => x.LocalGovernment).HasMaxLength(150); e.Property(x => x.City).HasMaxLength(150); e.Property(x => x.Genotype).HasMaxLength(10); e.Property(x => x.BloodGroup).HasMaxLength(10); e.Property(x => x.Disability).HasMaxLength(1000); e.Property(x => x.Skills).HasMaxLength(2000); e.Property(x => x.Achievements).HasMaxLength(3000); e.Property(x => x.Website).HasMaxLength(500); e.Property(x => x.OfficeAddress).HasMaxLength(1000); e.Property(x => x.SocialProfilesJson).HasMaxLength(4000); e.HasOne<StaffProfile>().WithOne().HasForeignKey<StaffSensitiveRecord>(x => new { x.TenantId, x.StaffId }).HasPrincipalKey<StaffProfile>(x => new { x.TenantId, x.Id }).OnDelete(DeleteBehavior.Cascade); });
        b.Entity<StaffEmploymentRecord>(e => { e.ToTable("StaffEmploymentRecords"); e.HasKey(x => x.Id); e.Property(x => x.EmployerName).HasMaxLength(200); e.Property(x => x.JobTitle).HasMaxLength(150); e.Property(x => x.ReasonForLeaving).HasMaxLength(500); e.HasIndex(x => new { x.TenantId, x.StaffId, x.StartedOn }); e.HasOne<StaffProfile>().WithMany().HasForeignKey(x => new { x.TenantId, x.StaffId }).HasPrincipalKey(x => new { x.TenantId, x.Id }).OnDelete(DeleteBehavior.Cascade); });
        b.Entity<StaffQualification>(e => { e.ToTable("StaffQualifications"); e.HasKey(x => x.Id); e.Property(x => x.Institution).HasMaxLength(200); e.Property(x => x.Name).HasMaxLength(200); e.Property(x => x.FieldOfStudy).HasMaxLength(150); e.Property(x => x.Grade).HasMaxLength(100); e.HasIndex(x => new { x.TenantId, x.StaffId, x.AwardedOn }); e.HasOne<StaffProfile>().WithMany().HasForeignKey(x => new { x.TenantId, x.StaffId }).HasPrincipalKey(x => new { x.TenantId, x.Id }).OnDelete(DeleteBehavior.Cascade); });
        b.Entity<StaffNextOfKin>(e => { e.ToTable("StaffNextOfKin"); e.HasKey(x => x.Id); e.Property(x => x.FullName).HasMaxLength(200); e.Property(x => x.Relationship).HasMaxLength(100); e.Property(x => x.Phone).HasMaxLength(30); e.Property(x => x.Email).HasMaxLength(320); e.Property(x => x.Address).HasMaxLength(1000); e.HasIndex(x => new { x.TenantId, x.StaffId, x.IsPrimary }).IsUnique().HasFilter("\"IsPrimary\" = TRUE"); e.HasOne<StaffProfile>().WithMany().HasForeignKey(x => new { x.TenantId, x.StaffId }).HasPrincipalKey(x => new { x.TenantId, x.Id }).OnDelete(DeleteBehavior.Cascade); });
    ...
    private static void ConfigureStudentLifecycle(ModelBuilder b)
    {
        ...
        b.Entity<Applicant>(e => { e.ToTable("Applicants"); e.HasKey(x => x.Id); e.HasAlternateKey(x => new { x.TenantId, x.Id }); e.Property(x => x.ApplicationNumber).HasMaxLength(50); e.Property(x => x.FirstName).HasMaxLength(100); e.Property(x => x.LastName).HasMaxLength(100); e.Property(x => x.Email).HasMaxLength(320); e.Property(x => x.Phone).HasMaxLength(30); e.Property(x => x.PreviousSchool).HasMaxLength(200); e.Property(x => x.Source).HasMaxLength(100); e.Property(x => x.Gender).HasMaxLength(30); e.Property(x => x.PreviousSchoolAddress).HasMaxLength(500); e.Property(x => x.LastClassCompleted).HasMaxLength(100); e.Property(x => x.ReasonForLeaving).HasMaxLength(500); e.HasIndex(x => new { x.TenantId, x.ApplicationNumber }).IsUnique(); e.HasOne<Tenant>().WithMany().HasForeignKey(x => x.TenantId).OnDelete(DeleteBehavior.Restrict); });
        b.Entity<ApplicantGuardian>(e => { e.ToTable("ApplicantGuardians"); e.HasKey(x => x.Id); e.HasAlternateKey(x => new { x.TenantId, x.Id }); e.Property(x => x.Name).HasMaxLength(200); e.Property(x => x.Phone).HasMaxLength(30); e.Property(x => x.Email).HasMaxLength(320); e.Property(x => x.Address).HasMaxLength(1000); e.HasIndex(x => new { x.TenantId, x.ApplicantId }); e.HasOne<Applicant>().WithMany().HasForeignKey(x => new { x.TenantId, x.ApplicantId }).HasPrincipalKey(x => new { x.TenantId, x.Id }).OnDelete(DeleteBehavior.Cascade); });
        b.Entity<Student>(e => { e.ToTable("Students"); e.HasKey(x => x.Id); e.HasAlternateKey(x => new { x.TenantId, x.Id }); e.Property(x => x.AdmissionNumber).HasMaxLength(50); e.Property(x => x.FirstName).HasMaxLength(100); e.Property(x => x.MiddleName).HasMaxLength(100); e.Property(x => x.LastName).HasMaxLength(100); e.Property(x => x.Gender).HasMaxLength(30); e.Property(x => x.Phone).HasMaxLength(30); e.Property(x => x.Email).HasMaxLength(320); e.HasIndex(x => new { x.TenantId, x.AdmissionNumber }).IsUnique(); e.HasIndex(x => new { x.TenantId, x.SourceApplicantId }).IsUnique().HasFilter("\"SourceApplicantId\" IS NOT NULL"); e.HasIndex(x => new { x.TenantId, x.UserId }).IsUnique().HasFilter("\"UserId\" IS NOT NULL"); e.HasOne<Tenant>().WithMany().HasForeignKey(x => x.TenantId).OnDelete(DeleteBehavior.Restrict); e.HasOne<PlatformUser>().WithMany().HasForeignKey(x => x.UserId).OnDelete(DeleteBehavior.Restrict).IsRequired(false); e.HasOne<Applicant>().WithOne().HasForeignKey<Student>(x => new { x.TenantId, x.SourceApplicantId }).HasPrincipalKey<Applicant>(x => new { x.TenantId, x.Id }).OnDelete(DeleteBehavior.Restrict).IsRequired(false); });
        b.Entity<Guardian>(e => { e.ToTable("Guardians"); e.HasKey(x => x.Id); e.HasAlternateKey(x => new { x.TenantId, x.Id }); e.Property(x => x.FirstName).HasMaxLength(100); e.Property(x => x.LastName).HasMaxLength(100); e.Property(x => x.Phone).HasMaxLength(30); e.Property(x => x.Email).HasMaxLength(320); e.Property(x => x.Gender).HasMaxLength(30); e.Property(x => x.Address).HasMaxLength(1000); e.HasIndex(x => new { x.TenantId, x.Phone }); e.HasIndex(x => new { x.TenantId, x.DeletedAtUtc }); e.HasOne<Tenant>().WithMany().HasForeignKey(x => x.TenantId).OnDelete(DeleteBehavior.Restrict); e.HasOne<PlatformUser>().WithMany().HasForeignKey(x => x.UserId).OnDelete(DeleteBehavior.Restrict).IsRequired(false); });
        ...
        b.Entity<StudentProgression>(e => { e.ToTable("StudentProgressions"); e.HasKey(x => x.Id); e.Property(x => x.Reason).HasMaxLength(1000); e.HasIndex(x => new { x.TenantId, x.StudentId, x.CreatedAtUtc }); e.HasOne<Student>().WithMany().HasForeignKey(x => new { x.TenantId, x.StudentId }).HasPrincipalKey(x => new { x.TenantId, x.Id }).OnDelete(DeleteBehavior.Restrict); e.HasOne<Enrollment>().WithMany().HasForeignKey(x => x.FromEnrollmentId).OnDelete(DeleteBehavior.Restrict); e.HasOne<Enrollment>().WithMany().HasForeignKey(x => x.ToEnrollmentId).OnDelete(DeleteBehavior.Restrict); });
        ...
        b.Entity<StudentSensitiveRecord>(e => { e.ToTable("StudentSensitiveRecords"); e.HasKey(x => new { x.TenantId, x.StudentId }); e.Property(x => x.Address).HasMaxLength(1000); e.Property(x => x.MedicalInformation).HasMaxLength(2000); e.Property(x => x.Allergies).HasMaxLength(1000); e.Property(x => x.SpecialEducationalNeeds).HasMaxLength(2000); e.Property(x => x.Genotype).HasMaxLength(10); e.Property(x => x.BloodGroup).HasMaxLength(10); e.Property(x => x.Disability).HasMaxLength(100); e.Property(x => x.PrivateNotes).HasMaxLength(2000); e.HasOne<Student>().WithOne().HasForeignKey<StudentSensitiveRecord>(x => new { x.TenantId, x.StudentId }).HasPrincipalKey<Student>(x => new { x.TenantId, x.Id }).OnDelete(DeleteBehavior.Cascade); });
