...
export type AccessContext = { userId: string; displayName: string; tenantId: string | null; tenantName: string | null; campusId: string | null; campusName: string | null; roles: string[]; audiences: PortalAudience[]; defaultAudience: PortalAudience; permissions: string[]; entitlements: Record<string, Entitlement> };
