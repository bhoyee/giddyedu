...
export type AccessContext = { userId: string; tenantId: string | null; campusId: string | null; roles: string[]; audiences: PortalAudience[]; defaultAudience: PortalAudience; permissions: string[]; entitlements: Record<string, Entitlement> };
